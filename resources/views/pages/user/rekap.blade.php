            ...
            <div class="container d-flex flex-column">
                ...
                <div class="row" data-aos="fade-left">
                    <div class="container d-flex gap-5">
                        <div>
                            <div class="card col-3" style="width: 18rem;">
                                <ul class="list-group list-group-flush">
                                    ...
                                    @endforeach
                                    <a href="{{ route('rekap') }}">
                                        @if (substr(request()->url(), -5) == 'rekap')
                                            <li class="list-group-item-active"><b>Rekap Data</b></li>
                                        @else
                        ...
                        <div class="col-9">
                            @foreach ($dataTanaman as $rekap)
                                <div class="tab-pane" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                                    tabindex="0">
                                    <!-- Canvas for Pie Chart -->
                                    <h3 class="mt-2"><b>{{ $rekap['tanaman'] }}</b></h3>
                                    <h4 class="mt-2">Clusters dan Label</h4>
                                    <div class="card card-bordered p-3">
                                        @php
                                            $clusterRangking = [];
                                            rsort($rekap['clusters']);
                                        @endphp
                                        @foreach ($rekap['clusters'] as $clusterIndex => $clusterData)
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($clusterData as $dataPoint)
                                                        ...
                                                        @endphp
                                                        <tr>
                                                            <td>{{ $rekap['kabupaten'][array_search($dataPoint, $rekap['dataInput'])] }}
                                                            </td>
